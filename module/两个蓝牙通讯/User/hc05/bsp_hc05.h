...
#define hc05_delay_ms   HAL_Delay
...
#define BLT_INT_GPIO_CLK_ENLAB()  __HAL_RCC_GPIOA_CLK_ENABLE(); /* GPIO端口时钟 */
#define BLT_INT_GPIO_PIN		  GPIO_PIN_5		           /* 连接到HC05 INT引脚的GPIO */

#define BLT_KEY_GPIO_PORT    	  GPIOA			               /* GPIO端口 */
#define BLT_KEY_GPIO_CLK_ENLAB()  __HAL_RCC_GPIOA_CLK_ENABLE(); /* GPIO端口时钟 */
