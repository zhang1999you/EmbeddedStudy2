...
#define BLT_USART_TX_GPIO_CLK  RCC_APB2Periph_GPIOA
#define BLT_USART_RX_GPIO_CLK  RCC_APB2Periph_GPIOA
#define BLT_USART_TX_GPIO_PORT    	  GPIOA		
#define BLT_USART_RX_GPIO_PORT    	  GPIOA	
